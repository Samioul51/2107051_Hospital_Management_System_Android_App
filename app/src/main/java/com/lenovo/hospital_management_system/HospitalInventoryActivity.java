...
public class HospitalInventoryActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_hospital_inventory);
    ...
    private void loadInventory() {
        database.addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onCancelled(@NonNull DatabaseError error) {
                Toast.makeText(HospitalInventoryActivity.this, "Failed to load inventory", Toast.LENGTH_SHORT).show();
            }
        });
    }
    ...
    private void deductItemFromInventory() {
        ...
        database.orderByChild("name").equalTo(itemName).addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                for (DataSnapshot itemSnapshot : snapshot.getChildren()) {
                    ...
                    if (currentQuantity != 0 && currentQuantity >= quantity) {
                        ...
                        Toast.makeText(HospitalInventoryActivity.this, "Item deducted from inventory", Toast.LENGTH_SHORT).show();
                    } else {
                        Toast.makeText(HospitalInventoryActivity.this, "Not enough stock to deduct", Toast.LENGTH_SHORT).show();
                    }
                }
            }
            ...
            @Override
            public void onCancelled(@NonNull DatabaseError error) {
                Toast.makeText(HospitalInventoryActivity.this, "Failed to deduct item", Toast.LENGTH_SHORT).show();
            }
        });
    }
}
